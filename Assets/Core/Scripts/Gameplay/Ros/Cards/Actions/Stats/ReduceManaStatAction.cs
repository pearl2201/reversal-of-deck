...
{
    public class ReduceManaStatAction : GameAction
    {
        public int value;
        ...
        public ReduceManaStatAction() : base(1) { }

        public ReduceManaStatAction(int value, IRosPlayer target, RosPlayerSlot playerSlot, int turnOrder = 1) : base(playerSlot, turnOrder) 
        {
            this.value = value;
